...
//<editor-fold desc="Version 2.0 Cloud">
...
// <editor-fold defaultstate="collapsed" desc="Version 1.0 Local">
/*
public class ConnectionBuilder  {
    ...
    try {      
        ...
        return DriverManager.getConnection("jdbc:mysql://localhost:3306/idina743_sgr", "root", "478403");
    } catch (Exception e){
