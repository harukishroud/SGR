...
public class SessionDAO {
    ...
    public void newSession(SessionBean session) throws SQLException, ExceptionDAO {
        ...
        System.out.println("[SESSION DAO] Values on current SQL are: Status '" + session.getStatus() + "', Código Cliente '" + session.getC_codigo() + 
    ...
    public boolean doOpenedSessionSearch(QueryBuilder query) throws SQLException, ExceptionDAO {
        ...
        while(rs.next()) {
            ...
            sessionStatus = sessionBean.getStatus();   
